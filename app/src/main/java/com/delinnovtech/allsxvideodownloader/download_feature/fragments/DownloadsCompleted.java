package com.delinnovtech.allsxvideodownloader.download_feature.fragments;
...
import com.delinnovtech.allsxvideodownloader.download_feature.VideoThumbDownloader;
import com.delinnovtech.allsxvideodownloader.download_feature.lists.CompletedVideos;
import com.delinnovtech.allsxvideodownloader.utils.RenameDialog;
...
public class DownloadsCompleted extends VDFragment implements DownloadsInProgress.OnAddDownloadedVideoToCompletedListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        completedVideos = CompletedVideos.load(requireActivity());
        ...
        if (view == null) {
            ...
            ImageButton clearAllFinishedButton = view.findViewById(R.id.clearAllFinishedButton);

            downloadsList = view.findViewById(R.id.downloadsCompletedList);


            ImageButton goToFolderButton = view.findViewById(R.id.goToFolder);
                    ...
                    new AlertDialog.Builder(getActivity())
                            ...
                            .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    Objects.requireNonNull(downloadsList.getAdapter()).notifyItemRangeRemoved(0, length);
    ...
    public void onResume() {
        ...
        Objects.requireNonNull(downloadsList.getAdapter()).notifyDataSetChanged();
    ...
    public void onAddDownloadedVideoToCompleted(final String name, final String type) {
        ...
        videos = completedVideos.getVideos();
        Objects.requireNonNull(downloadsList.getAdapter()).notifyItemInserted(0);
        onNumDownloadsCompletedChangeListener.onNumDownloadsCompletedChange();
    }
    ...
    private class VideoItem extends RecyclerView.ViewHolder implements ViewTreeObserver.OnGlobalLayoutListener {
        ...
        VideoItem(View itemView) {
                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                            ...
                            if (i == R.id.download_delete) {
                                ...
                                new RenameDialog(getActivity(), baseName) {
                                    ...
                                    public void onOK(String newName) {
                                        ...
                                        if (file.renameTo(renamedFile)) {
                                            ...
                                            completedVideos.save(getActivity());
                                            Objects.requireNonNull(downloadsList.getAdapter()).notifyItemChanged(getAdapterPosition());
                                        } else {
                                ...
                                try {
                                    ...
                                    Uri fileUri = FileProvider.getUriForFile(getContext(), "com.delinnovtech.allsxvideodownloader.fileprovider", file);
            ...
            thumbnail.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    File file = new File(Environment.getExternalStoragePublicDirectory(getString(R.string.app_name)), baseName + "." + type);
                    Uri fileUri = FileProvider.getUriForFile(getActivity(), "com.delinnovtech.allsxvideodownloader.fileprovider", file);
        ...
        void bind(String video) {
            ...
            type = video.substring(video.lastIndexOf(".") + 1);
            ...
            if (file.exists()) {
                ...
                videos.remove(position);
                completedVideos.save(getActivity());
                Objects.requireNonNull(downloadsList.getAdapter()).notifyItemRemoved(position);
                onNumDownloadsCompletedChangeListener.onNumDownloadsCompletedChange();
            }
