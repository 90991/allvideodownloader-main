package com.delinnovtech.allsxvideodownloader.download_feature;
...
public class DownloadNotifier {
        ...
        public void run() {
            ...
            NB.setContentTitle("Downloading " + filename)
                    ...
                    .setLargeIcon(BitmapFactory.decodeResource(VDApp.getInstance()
                            .getApplicationContext().getResources(), R.drawable.ic_down_arrow))
                    .setOngoing(true);
    ...
    public DownloadNotifier(Intent downloadServiceIntent) {
