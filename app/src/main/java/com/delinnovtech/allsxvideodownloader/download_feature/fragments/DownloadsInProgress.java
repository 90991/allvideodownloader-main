...
import com.delinnovtech.allsxvideodownloader.download_feature.DownloadNotifier;
...
import com.delinnovtech.allsxvideodownloader.download_feature.DownloadManager;
...
import com.delinnovtech.allsxvideodownloader.download_feature.OnDownloadWithNewLinkListener;
import com.delinnovtech.allsxvideodownloader.download_feature.Tracking;
                                ...
                                new AlertDialog.Builder(getActivity())
                                        ...
                                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog, int which) {
                                                ...
                                                downloads.remove(position2);
                                                saveQueues();
                                                getAdapter().notifyItemRemoved(position2);
                                                DownloadManager.stop();
                                                tracking.stopTracking();
                                                getAdapter().pause();
                                                onNumDownloadsInProgressChangeListener.onNumDownloadsInProgressChange();
